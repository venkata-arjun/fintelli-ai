        ...
        content_json: {
            ...
            recommendations: [
                ...
                },
                {
                    ...
                    detail: 'Keep Food & Dining near its current pace and move the resulting monthly headroom into savings.',
                    estimatedSavings: 80,
                },
                {
                    category: 'Food & Dining',
            ...
            estimatedAdditionalSavings: 140,
            healthScore: 78,
        },
    },
    {
...
export const mockInsightGenerators = {
    monthly_summary: {
        ...
        recommendations: [
            { category: 'Shopping', title: 'Freeze Shopping for two weeks', detail: 'Pause non-essential purchases to recover the $20 overage and finish the month under budget.', estimatedSavings: 20 },
            { category: 'Food & Dining', title: 'Set a weekly food limit', detail: 'Aim for ~$80/week on Food & Dining to create monthly headroom from the $320 category total.', estimatedSavings: 40 },
            { category: 'Entertainment', title: 'Consolidate subscriptions', detail: 'Drop one of Netflix, Spotify, or YouTube Premium for a quick monthly win from Entertainment spending.', estimatedSavings: 16 },
        ],
        topSpendingCategory: 'Rent',
        estimatedAdditionalSavings: 76,
        healthScore: 78,
    },
    savings_tips: {
